/* I.S: program asked for data input
F.S: program output will be buy and sell signal
*/
...
var MarketData[100000] PriceType
var i int64
var date int64
var time int64
var opening float64
...
func main() {
	...
	if err == nil {
	    for err != io.EOF && i < 100000 {
	        fmt.Scanf("%d %d;%v;%v;%v;%v;0\n", &date, &time, &opening, &high, &low, &closing)
